...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        LCTL(KC_LGUI), KC_RO, KC_JYEN, KC_LALT, KC_DELT,
                                                                    KC_LSFT,         KC_SPC,
                                                                                     KC_HOME,
                                                                    KC_BSPC,         LT(DDWW, KC_F15), KC_LGUI,
        // right hand
             ...
             KC_RSFT, KC_RALT,
             KC_END,
             KC_RGUI, LT(SYMB,KC_F16), SFT_T(KC_SPC)
    ),
 ...
 * |        |      |      |      |      |      |      |           |      |      |      |      |      |      |        |
 * |--------+------+------+------+------+-------------|           |------+------+------+------+------+------+--------|
 * |        | ZKHK |      | MsUp |      |      |      |           |      |SCRL< |SCRL↓ |SCRL↑ |SCRL> | Play |        |
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
...
[MDIA] = KEYMAP(
    ...
    // right hand
       KC_TRNS,  KC_NO,         KC_NO,         KC_NO,       KC_NO,          KC_NO,   KC_TRNS,
       KC_TRNS,  KC_MS_WH_LEFT, KC_MS_WH_DOWN, KC_MS_WH_UP, KC_MS_WH_RIGHT,   KC_MPLY, KC_TRNS,
