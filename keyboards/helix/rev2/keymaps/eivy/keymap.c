...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
  [_LOWER] = LAYOUT( \
      _______, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_L, KC_WH_R,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
      _______, XXXXXXX, KC_MS_U, XXXXXXX, KC_WH_D, KC_WH_U,                   KC_CIRC, KC_PLUS, KC_ASTR, XXXXXXX, KC_LPRN, KC_RPRN, \
      _______, KC_MS_L, KC_MS_D, KC_MS_R, KC_BTN1, KC_BTN2,                   XXXXXXX, KC_UNDS, KC_PLUS, XXXXXXX, KC_LBRC, KC_RBRC, \
      _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY, XXXXXXX, _______, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, \
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, XXXXXXX, KC_NUMLOCK,XXXXXXX,  XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_TILD, KC_F12, \
      _______, KC_CAPS, KC_SLCK,   KC_INSERT,KC_PSCR, KC_PAUSE,                  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_PIPE, XXXXXXX,\
      _______, XXXXXXX, XXXXXXX,   XXXXXXX,  XXXXXXX, XXXXXXX, _______, KC_DEL,  _______, KC_APP,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
      _______, _______, _______,   _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      XXXXXXX, XXXXXXX, RGBRST,  XXXXXXX, XXXXXXX, AG_SWAP,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,\
